...
Issues live in GitHub Issues (`TiraelSedai/PhotoChallengeBot`), managed via the `gh` CLI. External PRs are not a triage surface. See `docs/agents/issue-tracker.md`.
